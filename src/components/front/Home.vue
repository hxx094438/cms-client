  ...
  <div class="container">
    <section class="newBlog">
      ...
      <div class="posts animated fadeIn">
        <div class="flex">
          <div v-for="(article, index) in reducedArticles(articles)" :key="index" class="oneArticle">
            <router-link
          ...
          <span @click="LoadArticles" v-if="!noMore" v-show="!noMore"
                class=" animated fadeIn loadMore"><i>more</i></span>
